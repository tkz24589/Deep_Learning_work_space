...
class multiLoss():
    def __init__(self, bce_wight=0.5, lovasz_weight=0.5) -> None:
        self.bce = nn.BCEWithLogitsLoss()
        self.lovasz = LovaszLoss(loss_type='binary', per_image=False, reduction='none')
        self.bce_wight = bce_wight
        self.lovasz_weight = lovasz_weight
    def loss(self, pred, true):
        bce = self.bce(pred, true)
        lovasz = self.lovasz(pred, true)
        return bce * self.bce_wight + lovasz * self.lovasz_weight
