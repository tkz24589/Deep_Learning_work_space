...
from models.hybrik.hybrikTransformerSMPL24 import HybrikTransformerSMPL24
...
parser.add_argument('--checkpoint', default='logs/comparison/spin/checkpoints/spin-sketch-best.pt',
...
class Eval():
    def __init__(self, options):
        ...
        self.model = HybrikTransformerSMPL24()
...
if __name__ == '__main__':
    ...
    model = spin(config.SMPL_MEAN_PARAMS, pretrained=True)
    ...
    if args.checkpoint != None:
        ...
        try:
            ...
            model.load_state_dict(checkpoint['shpr'], strict=False)
        print('gnn checkpoint load')
    # if args.pose_checkpoint_file != None:
    #     checkpoint = torch.load(args.pose_checkpoint_file)
    #     try:
    #         model.feature.load_state_dict(checkpoint['model'], strict=False)
    #     except:
    #         model.feature.load_state_dict(checkpoint['shpr'], strict=False)
    #     print('cnn checkpoint load')
    model.eval()
