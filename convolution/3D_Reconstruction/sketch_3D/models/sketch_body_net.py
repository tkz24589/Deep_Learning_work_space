...
class Sketch_Body_Net(nn.Module):
    def __init__(self, smpl_mean_params=None, type='all'):
        super(Sketch_Body_Net, self).__init__()
        self.cam_size = 3
        self.pose_size = 144
        self.shape_size = 10
...
def sketch_body_net(smpl_mean_params=None,
        pretrained=False,
    ...
    """ Constructs an HMR model with ResNet50 backbone.
        ...
        """
    model = Sketch_Body_Net(smpl_mean_params, type)
    if pretrained:
...
if __name__== "__main__" :
    net = sketch_body_net(smpl_mean_params=config.SMPL_MEAN_PARAMS)
