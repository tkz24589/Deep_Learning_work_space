...
if __name__ == '__main__':
    ...
    parser.add_argument('--source', type=str, default='datasets/score/3D19E9CF8692FEE44FF45A1FF7C345C2.png', help='source')  # file/folder, 0 for webcam
    parser.add_argument('--output', type=str, default='datasets/score/result', help='output folder')  # output folder
